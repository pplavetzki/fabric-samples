...
func main() {
	...
	result, err := contract.SubmitTransaction("redeem", "MagnetoCorp", "00001", "DigiBank", "2020-11-30")
	if err != nil {
	...
	logger.Sugar().Infof("%s commercial paper: %s successfully redeemed with %s\n", paper.Issuer, paper.PaperNumber, paper.Owner)
